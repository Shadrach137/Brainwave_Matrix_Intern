...
# Example usage
video_id = "h3BKjZMGoIw"  # Replace with the actual video ID
comments = fetch_comments(video_id)
print(f"Fetched {len(comments)} comments")

# Save to a CSV
df = pd.DataFrame(comments)
df.to_csv("YouTube_iPhone_Comments_with_Timestamps.csv", index=False)
print("Comments saved to YouTube_iPhone_Comments_with_Timestamps.csv")
